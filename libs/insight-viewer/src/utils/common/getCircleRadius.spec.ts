...
describe('getCircleRadius:', () => {
  it('should calculate circle radius without Image', () => {
    ...
    expect(getCircleRadius(MOCK_START_POINT_1, MOCK_END_POINT_1, null)).toEqual({
      radius: 7.0710678118654755,
      unit: 'px',
    })
    expect(getCircleRadius(MOCK_START_POINT_2, MOCK_END_POINT_2, null)).toEqual({
      radius: 12.727922061357855,
      unit: 'px',
    })
    expect(getCircleRadius(MOCK_START_POINT_3, MOCK_END_POINT_3, null)).toEqual({
