// TODO 완성되면 DefinitelyTyped 로 배포

// https://docs.cornerstonejs.org/api.html
...
declare module 'cornerstone-core' {
   ...
   */
  export function triggerEvent(el: EventTarget, type: EventTypes, detail: CornerstoneEventData | null);
}
