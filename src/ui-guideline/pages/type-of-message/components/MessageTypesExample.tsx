                ...
                <Button
                  ...
                  onClick={() => {
                    openAlert({
                      title: 'Alert 예제',
                      description:
                        'Dialog 방식의 경우 사용자에게 강제적인 집중을 요구하게 됩니다',
                      agree: '확인',
                    });
                  }}
                />
                <Button
                  ...
                  onClick={() => {
                    openConfirm({
                      title: 'Confirm 예제',
                      description:
                        'Dialog는 이와같이 강제적인 사용자 확인을 요구할 때 사용할 때 효과적입니다',
                      agree: 'OK',
                      disagree: 'Cancel',
                    });
                  }}
                        ...
                        <InfoSnackbarContent
                          message={
                            <p>
                              ...
                              <br />
                              <u>사용자가 원하는 경우</u>에 거부할 수 있는
                              보조적 선택에 활용할 수 있습니다.
                              <br />
                              거부하지 않으면 시스템에 의해 기본적인 Action이
                              실행됩니다.
                            </p>
                          }
                          action={[
          ...
          sidepanel: (
            <>
              <Panel title="MESSAGE PANEL">
                <PanelDescription>
                  Panel을 사용하는데 있어서 중요하고, 꼭 보여져야 하는 메세지는
                  이렇게 표시할 수 있습니다.
                </PanelDescription>
                <div>...</div>
              </Panel>
