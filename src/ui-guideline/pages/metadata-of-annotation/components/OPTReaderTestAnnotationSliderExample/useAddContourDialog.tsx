import { Button, ButtonLayout, Dialog, DialogActions, DialogContent, DialogTitle, Slider } from '@lunit/opt-components';
  ...
  return (
    ...
    >
      ...
      <DialogContent style={{ width: 270 }}>
        <Slider value={confidenceLevel} onChange={(event, value) => setConfidenceLevel(+value)} />
      </DialogContent>
      <DialogActions>
