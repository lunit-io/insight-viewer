...
export const RULER_MEASUREMENTS: RulerMeasurement[] = [
  {
    ...
    calculatedPixelValueByUnit: 26.13,
  ...
  },
  {
    ...
    calculatedPixelValueByUnit: 22.5,
  ...
  },
  {
    ...
    calculatedPixelValueByUnit: 41.33,
  ...
  },
  {
    ...
    calculatedPixelValueByUnit: 38.2,
...
export const SMALLER_THAN_MINIMUM_LENGTH_RULER_MEASUREMENT: RulerMeasurement = {
  ...
  calculatedPixelValueByUnit: 1.0101520273541005,
  unit: 'mm',
  textPoint: null,
}
