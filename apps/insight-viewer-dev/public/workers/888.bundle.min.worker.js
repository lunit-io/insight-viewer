;(self.webpackChunkcornerstoneWADOImageLoader = self.webpackChunkcornerstoneWADOImageLoader || []).push([
  ...
  {
    1888: function (e, r) {
      var n = { Unkown: 0, Grayscale: 1, AdobeRGB: 2, RGB: 3, CYMK: 4 },
        o = (function () {
          'use strict'
          ...
          function u(e, r) {
            ...
            for (n = 0; n < s; n++) {
              for (o = 0; o < e[n]; o++) {
                for ((c = t.pop()).children[c.index] = r[a]; c.index > 0; ) c = t.pop()
                for (c.index++, t.push(c); t.length <= n; )
                  t.push((i = { children: [], index: 0 })), (c.children[c.index] = i.children), (c = i)
                a++
              }
              n + 1 < s && (t.push((i = { children: [], index: 0 })), (c.children[c.index] = i.children), (c = i))
            }
            return t[0].children
          }
          function h(e, r, n) {
          ...
          function b(r, n, o, a, t, s, i, c, l) {
            ...
            function d(e) {
              for (var r, n = e; null !== (r = p()); ) {
                if ('number' == typeof (n = n[r])) return n
            ...
            U = u
              ? 0 === s
                ...
                : function (r, n) {
                    for (var o = s, a = i, t = 0; o <= a; ) {
                      var c = e[o]
                      switch (g) {
                        case 0:
                          var f = d(r.huffmanTableAC),
                            u = 15 & f
                          if (((t = f >> 4), 0 === u)) t < 15 ? ((C = k(t) + (1 << t)), (g = 4)) : ((t = 16), (g = 1))
                          else {
                            if (1 !== u) throw 'invalid ACn encoding'
                            ;(P = w(u)), (g = t ? 2 : 3)
                          }
                          continue
                        case 1:
                        case 2:
                          r.blockData[n + c] ? (r.blockData[n + c] += p() << l) : 0 == --t && (g = 2 == g ? 3 : 0)
                          break
                        case 3:
                          r.blockData[n + c]
                            ? (r.blockData[n + c] += p() << l)
              ...
              : function (r, n) {
                  var o = d(r.huffmanTableDC),
                    a = 0 === o ? 0 : w(o)
                  r.blockData[n] = r.pred += a
                  for (var t = 1; t < 64; ) {
                    var s = d(r.huffmanTableAC),
                      i = 15 & s,
                      c = s >> 4
                    if (0 !== i) {
                      var l = e[(t += c)]
            ...
            var G,
              ...
              H,
              O = 0
            for (M = 1 == q ? a[0].blocksPerLine * a[0].blocksPerColumn : f * o.mcusPerColumn, t || (t = M); O < M; ) {
              for (x = 0; x < q; x++) a[x].pred = 0
              if (((C = 0), 1 == q)) for (y = a[0], I = 0; I < t; I++) L(y, U, O), O++
              else
                for (I = 0; I < t; I++) {
                  for (x = 0; x < q; x++)
                    for (z = (y = a[x]).h, H = y.v, A = 0; A < H; A++) for (T = 0; T < z; T++) D(y, U, O, A, T)
                  O++
                }
              if (((m = 0), (G = (r[n] << 8) | r[n + 1]) <= 65280)) throw 'marker was not found'
          ...
          function m(e, r) {
            for (var n = r.blocksPerLine, o = r.blocksPerColumn, a = new Int32Array(64), t = 0; t < o; t++)
              for (var s = 0; s < n; s++) {
                v(r, h(r, t, s), a)
              }
            return r.blockData
          ...
          return (
            (f.prototype = {
              load: function (e) {
                ...
                if (e.indexOf('data:') > -1) {
                  ...
                  s.open('GET', e, !0),
                    ...
                    (s.onload = function () {
                      var e = new Uint8Array(s.response)
                      r(e)
                    }.bind(this)),
                    s.send(null)
                }
              ...
              parse: function (r) {
                ...
                function a() {
                  var e = o(),
                    n = r.subarray(c, c + e - 2)
                  return (c += n.length), n
                }
                function t(e) {
                  for (
                    var r = Math.ceil(e.samplesPerLine / 8 / e.maxH), n = Math.ceil(e.scanLines / 8 / e.maxV), o = 0;
                    o < e.components.length;
                    o++
                  ) {
                    S = e.components[o]
                    var a = Math.ceil((Math.ceil(e.samplesPerLine / 8) * S.h) / e.maxH),
                      t = Math.ceil((Math.ceil(e.scanLines / 8) * S.v) / e.maxV),
                      s = r * S.h,
                      i = 64 * (n * S.v) * (s + 1)
                    ;(S.blockData = new Int16Array(i)), (S.blocksPerLine = a), (S.blocksPerColumn = t)
                  }
                ...
                var s,
                  ...
                  p = [],
                  d = o()
                if (65496 != d) throw 'SOI not found'
                for (d = o(); 65497 != d; ) {
                  var k, w
                  switch (d) {
                    case 65504:
                    ...
                    case 65498:
                      ...
                      var O = r[c++],
                        R = []
                      for (J = 0; J < O; J++) {
                        var V = s.componentIds[r[c++]]
                        S = s.components[V]
                        var Y = r[c++]
                        ;(S.huffmanTableDC = p[Y >> 4]), (S.huffmanTableAC = v[15 & Y]), R.push(S)
                      }
                      var B = r[c++],
                        X = r[c++],
                        j = r[c++],
                        E = b(r, c, s, R, i, B, X, j >> 4, 15 & j)
                      c += E
                      break
                    case 65535:
                      255 !== r[c] && c--
                ...
                switch (
                  ...
                  case 1:
                    ...
                    break
                  case 3:
                    this.adobe ? (this.colorspace = n.AdobeRGB) : (this.colorspace = n.RGB)
                    break
                  case 4:
              ...
              getData16: function (e, r) {
                if (1 !== this.components.length) throw 'Unsupported color mode'
                var n,
                  o,
                  a,
                  t,
                  ...
                  l = this.height / r,
                  f = 0,
                  u = this.components.length,
                  b = new Uint16Array(e * r * u),
                  v = new Uint16Array((this.components[0].blocksPerLine << 3) * this.components[0].blocksPerColumn * 8)
                for (i = 0; i < u; i++) {
                  for (
                    var m,
                      p,
                  ...
                  for (o = n.scaleX * c, a = n.scaleY * l, f = i, s = 0; s < r; s++)
                    for (t = 0; t < e; t++) (d = (0 | (s * a)) * C + (0 | (t * o))), (b[f] = v[d]), (f += u)
                }
                return b
              },
              getData: function (e, r) {
                var n,
                  ...
                  D = e * r * g,
                  L = new Uint8Array(D),
                  y = new Uint8Array((this.components[0].blocksPerLine << 3) * this.components[0].blocksPerColumn * 8)
                for (i = 0; i < g; i++) {
                  for (
                    var x,
                      A,
                    ...
                    for (var z = M << 3, H = 0; H < I; H++) {
                      var O = h(n, M, H),
                        R = ((P = 0), H << 3)
                      for (x = 0; x < 8; x++) {
                        G = (z + x) * q
                        for (A = 0; A < 8; A++) y[G + R + A] = n.output[O + P++] * n.bitConversion
                      }
                    }
                  for (o = n.scaleX * w, a = n.scaleY * C, P = i, s = 0; s < r; s++)
                    for (t = 0; t < e; t++) (T = (0 | (s * a)) * q + (0 | (t * o))), (L[P] = y[T]), (P += g)
                }
                switch (g) {
                  case 1:
                  case 2:
                  ...
                  case 3:
                    if (
                      ...
                      this.adobe && this.adobe.transformCode
                        ? (k = !0)
                        : void 0 !== this.colorTransform && (k = !!this.colorTransform),
                      k)
                    )
                      for (i = 0; i < D; i += g)
                        (c = L[i]),
